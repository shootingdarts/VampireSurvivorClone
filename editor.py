...
from scripts.utils import load_images, load_sprite_sheet
...
class Editor:
    ...
    def __init__(self):
        ...
        self.assets = {
            ...
            'grass': load_sprite_sheet('tiles/grass/Grass.png', (16, 16), 6),
    ...
    def run(self):
        while True:
            ...
            if self.clicking and self.ongrid:
                self.tilemap.foreground_tiles[str(tile_pos[0]) + ';' + str(tile_pos[1])] = {
